...
function Iu() {
 ...
 - ${c}: ${l}`, r && (o += encodeURI(c) + "=" + encodeURI(l));
      ...
      let Bt = St, { parse: Ie } = yt, { charts: Ns, composed: sc, isTouchDevice: rc } = X, { addEvent: Me, attr: oc, css: Jn, extend: Qn, find: zl, fireEvent: wi, isNumber: ma, isObject: fa, objectEach: ac, offset: nc, pick: Ze, pushUnique: lc, splat: Fl } = $;
      class jt {
        ...
        destroy() {
          let t = this;
          this.eventsToUnbind.forEach((e) => e()), this.eventsToUnbind = [], !X.chartCount && (jt.unbindDocumentMouseUp.forEach((e) => e.unbind()), jt.unbindDocumentMouseUp.length = 0, jt.unbindDocumentTouchEnd && (jt.unbindDocumentTouchEnd = jt.unbindDocumentTouchEnd())), clearInterval(t.tooltipTimeout), ac(t, function(e, i) {
            t[i] = void 0;
          });
        }
        ...
        getChartPosition() {
          ...
          let { container: t } = this.chart, e = nc(t);
      ...
      jt.unbindDocumentMouseUp = [], (function(h) {
        h.compose = function(t) {
          lc(sc, "Core.Pointer") && Me(t, "beforeRender", function() {
      ...
      let { setLength: hc, splice: Wl } = ni, { fireEvent: tl, objectEach: jr, uniqueKey: Ur } = $, xa = class {
        constructor(h = {}) {
        ...
        applyRowCount(h) {
          this.rowCount = h, jr(this.columns, (t, e) => {
            t.length !== h && (this.columns[e] = hc(t, h));
          });
        }
        deleteRows(h, t = 1) {
      ...
      (function(h) {
        function t(e, i, s) {
          ...
          if (T && T.enabled !== !1 && c) {
            ...
            d.indexOf("url") === 0 && (T = dc(T, { width: m, height: m }), O = 0), r.symbol = v = x.symbol(d, c / 2 - O, M - O, 2 * O, 2 * O, cc({ context: "legend" }, T)).addClass("highcharts-point").add(y), v.isMarker = !0;
          }
        }
      ...
      let Gl = Qe, { defaultOptions: Yl } = te, { extend: uc, extendClass: pc, merge: gc } = $;
      (function(h) {
        function t(e, i) {
        ...
        h.seriesTypes = X.seriesTypes, h.registerSeriesType = t, h.seriesType = function(e, i, s, r, o) {
          ...
          if (i = i || "", a[e] = gc(a[i], s), delete h.seriesTypes[e], t(e, pc(h.seriesTypes[i] || ce, r)), h.seriesTypes[e].prototype.type = e, o) {
            class l extends Bt {
            }
      ...
      let Nt = He, { animObject: jl, setAnimation: mc } = Rt, { defaultOptions: ba } = te, { registerEventOptions: fc } = fi, { svg: xc, win: bc } = X, { seriesTypes: Rs } = Nt, { format: yc } = Jt, { arrayMax: el, arrayMin: Ul, clamp: Vl, correctFloat: ql, crisp: vc, defined: Gt, destroyObjectProperties: kc, diffObjects: wc, erase: Kl, error: ya, extend: zs, find: Mc, fireEvent: Pt, getClosestDistance: Cc, getNestedProperty: $l, insertItem: Zl, isArray: _l, isNumber: Ut, isString: Ac, merge: Vr, objectEach: il, pick: Ot, removeEvent: Tc, syncTimeout: Jl } = $;
      class Be {
        constructor() {
          this.zoneAxis = "y";
        }
        ...
        getName() {
          return this.options.name ?? yc(this.chart.options.lang.seriesName, this, this.chart);
        }
        getCyclic(t, e, i) {
        ...
        findPointIndex(t, e) {
          ...
          if (o) {
            ...
            if (c?.matchByName ? d = (f) => !f.touched && f.name === t.name : this.options.relativeXValue && (d = (f) => !f.touched && f.options.x === t.x), !(i = Mc(l, d))) return;
          }
        ...
        setData(t, e = !0, i, s) {
          ...
          if (c?.enabled && (t = this.sortData(t)), l.options.chart.allowMutatingData && s !== !1 && D && o && !this.cropped && !this.hasGroupedData && this.visible && !this.boosted && (T = this.updateData(t, i)), !T) {
            ...
            for (Ac(this.getColumn("y")[0]) && ya(14, !0, l), this.data = [], this.options.data = this.userOptions.data = t, v = o; v--; ) r[v]?.destroy();
        ...
        markerAttribs(t, e) {
          ...
          let d = t.pos();
          return Ut(m) && d && (i.crisp && (d[0] = vc(d[0], t.hasImage ? 0 : o === "rect" ? s?.lineWidth || 0 : 1)), a.x = d[0] - m, a.y = d[1] - m), m && (a.width = a.height = 2 * m), a;
        }
        pointAttribs(t, e) {
        ...
        destroy(t) {
          let e, i, s = this, r = s.chart, o = /AppleWebKit\/533/.test(bc.navigator.userAgent), a = s.data || [];
          ...
          for (let l of s.zones) kc(l, void 0, !0);
        ...
        drawTracker() {
          ...
          }, m = "rgba(192,192,192," + (xc ? 1e-4 : 2e-3) + ")", d = t.tracker;
        ...
        removePoint(t, e, i) {
          ...
          mc(i, r), e = Ot(e, !0), c ? c.firePointEvent("remove", null, m) : m();
        }
        remove(t, e, i, s) {
        ...
        update(t, e) {
          Pt(this, "update", { options: t = wc(t, this.userOptions) });
      ...
      let ce = Be, { animObject: Sc, setAnimation: Ec } = Rt, { registerEventOptions: Ql } = fi, { composed: Pc, marginNames: th } = X, { distribute: Oc } = fs, { format: Lc } = Jt, { addEvent: va, createElement: Dc, css: Ic, defined: sl, discardElement: Bc, find: Nc, fireEvent: ai, isNumber: eh, merge: Zi, pick: Ne, pushUnique: Rc, relativeLength: zc, stableSort: Fc, syncTimeout: Hc } = $;
      class rl {
        constructor(t, e) {
        ...
        destroyItem(t) {
          ...
          t.checkbox = Bc(t.checkbox), t.legendItem = void 0;
        }
        destroy() {
        ...
        positionCheckboxes() {
          ...
          e && (t = e.translateY, this.allItems.forEach(function(r) {
            let o, a = r.checkbox;
            a && (o = t + s + a.y + (this.scrollOffset || 0) + 3, Ic(a, { left: e.translateX + r.checkboxOffset + a.x - 20 + "px", top: o + "px", display: this.proximate || o > t - 6 && o < t + i - 6 ? "" : "none" }));
          }, this));
        }
        renderTitle() {
        ...
        setText(t) {
          let e = this.options;
          t.legendItem.label.attr({ text: e.labelFormat ? Lc(e.labelFormat, t, this.chart) : e.labelFormatter.call(t) });
        }
        renderItem(t) {
        ...
        proximatePositions() {
          ...
          for (let r of (this.allItems.forEach(function(o) {
            let a, l, c = s, m, d;
            o.yAxis && (o.xAxis.options.reversed && (c = !c), o.points && (a = Nc(c ? o.points : o.points.slice(0).reverse(), function(f) {
              return eh(f.plotY);
        ...
        scroll(t, e) {
          ...
          m > r && (m = r), m > 0 && (e !== void 0 && Ec(e, i), this.nav.attr({ translateX: c, translateY: o + this.padding + 7 + this.titleHeight, visibility: "inherit" }), [this.up, this.upTracker].forEach(function(d) {
        ...
        createCheckboxForItem(t) {
          t.checkbox = Dc("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: t.selected, defaultChecked: t.selected }, this.options.itemCheckboxStyle, this.chart.container), va(t.checkbox, "click", function(e) {
            let i = e.target;
      ...
      (function(h) {
        h.compose = function(t) {
          Rc(Pc, "Core.Legend") && va(t, "beforeMargins", function() {
            this.legend = new h(this, this.options.legend);
          });
        };
      })(rl || (rl = {}));
      let ih = rl, { animate: ol, animObject: Wc, setAnimation: al } = Rt, { defaultOptions: nl } = te, { numberFormat: Xc } = Jt, { registerEventOptions: sh } = fi, { charts: _i, doc: qr, marginNames: rh, svg: Gc, win: oh } = X, { seriesTypes: ll } = Nt, { addEvent: hl, attr: ah, createElement: cl, css: Re, defined: Mi, diffObjects: nh, discardElement: Yc, erase: jc, error: dl, extend: Ci, find: ul, fireEvent: ut, getAlignFactor: Uc, getStyle: pl, isArray: Vc, isNumber: Fs, isObject: qc, isString: ka, merge: _e, objectEach: gl, pick: ee, pInt: Kc, relativeLength: lh, removeEvent: hh, splat: wa, syncTimeout: $c, uniqueKey: Zc } = $;
      class Ai {
        static chart(t, e, i) {
          return new Ai(t, e, i);
        }
        ...
        layOutTitles(t = !0) {
          ...
          ["title", "subtitle", "caption"].forEach((a) => {
            ...
            if (l && c) {
              ...
              if (L.height = N, l.align(L, !1, m).attr({ align: L.align, scaleX: O, scaleY: O, "transform-origin": `${m.x + d * O * Uc(L.align)} ${y}` }), !c.floating) {
                let I = N * (N < 1.2 * y ? 1 : O);
        ...
        getContainer() {
          let t, e = this.options, i = e.chart, s = "data-highcharts-chart", r = Zc(), o = this.renderTo, a = Kc(ah(o, s));
          ...
          let d = i.renderer || !Gc ? zi.getRendererType(i.renderer) : Ms;
        ...
        reflow(t) {
          ...
          delete e.pointer?.chartPosition, !e.exporting?.isPrinting && !e.isResizing && i && s.width && ((s.width !== i.width || s.height !== i.height) && ($.clearTimeout(e.reflowTimeout), e.reflowTimeout = $c(function() {
        ...
        destroy() {
          ...
          for (ut(e, "destroy"), e.renderer.forExport ? jc(_i, e) : _i[e.index] = void 0, X.chartCount--, e.renderTo.removeAttribute("data-highcharts-chart"), hh(e), t = i.length; t--; ) i[t] = i[t].destroy();
          ...
          ["title", "subtitle", "chartBackground", "plotBackground", "plotBGImage", "plotBorder", "seriesGroup", "clipRect", "credits", "pointer", "rangeSelector", "legend", "resetZoomButton", "tooltip", "renderer"].forEach((a) => {
            e[a] = e[a]?.destroy?.();
          }), r && (r.innerHTML = Ct.emptyHTML, hh(r), o && Yc(r)), gl(e, function(a, l) {
            delete e[l];
          });
        }
        firstRender() {
      ...
      let { stop: _c } = Rt, { composed: Jc } = X, { addEvent: Ti, createElement: Ma, css: ml, defined: fl, erase: Qc, merge: ch, pushUnique: dh } = $;
      function td() {
      ...
      class Kr {
        static compose(t, e, i) {
          dh(Jc, this.compose) && (Ti(t, "afterInit", uh), Ti(e, "afterSetChartSize", (s) => this.afterSetSize(s.target, s)), Ti(e, "render", td), Ti(i, "show", uh));
        }
        ...
        applyFixed() {
          ...
          e.setSize(o, a), (i ?? !0) && (this.isDirty = !1, this.moveFixedElements()), _c(t.container), ml(l, { width: `${v}px`, height: `${T}px` }), t.renderer.boxWrapper.attr({ width: v, height: T, viewBox: [0, 0, v, T].join(" ") }), t.chartBackground?.attr({ width: v, height: T }), ml(s, { width: `${o}px`, height: `${a}px` }), fl(i) || (s.scrollLeft = x * M, s.scrollTop = y * w);
        ...
        moveFixedElements() {
          ...
          else for (let l of [".highcharts-xaxis", ".highcharts-yaxis"]) for (let c of [`${l}:not(.highcharts-radial-axis)`, `${l}-labels:not(.highcharts-radial-axis-labels)`]) Qc(a, c);
      ...
      let { format: ed } = Jt, { series: id } = Nt, { destroyObjectProperties: sd, fireEvent: ph, getAlignFactor: xl, isNumber: bl, pick: $r } = $, gh = class {
        constructor(h, t, e, i, s) {
        ...
        render(h) {
          let t = this.axis.chart, e = this.options, i = e.format, s = i ? ed(i, this, t) : e.formatter.call(this);
        ...
        setOffset(h, t, e, i, s, r) {
          ...
          if (l && f) {
            ...
            f.x -= T, f.y -= S, l.align(o, !1, f), (v = d.isInsidePlot(l.alignAttr.x + o.x + T, l.alignAttr.y + o.y + S)) || (w = !1), w && id.prototype.justifyDataLabel.call(a, l, o, l.alignAttr, y, f), l.attr({ x: l.alignAttr.x, y: l.alignAttr.y, rotation: c.rotation, rotationOriginX: y.width * xl(c.textAlign || "center"), rotationOriginY: y.height / 2 }), $r(!w && c.crop, !0) && (v = bl(l.x) && bl(l.y) && d.isInsidePlot(l.x - M + (l.width || 0), l.y) && d.isInsidePlot(l.x + M, l.y)), l[v ? "show" : "hide"]();
          }
      ...
      }, { getDeferredAnimation: rd } = Rt, { series: { prototype: od } } = Nt, { addEvent: mh, correctFloat: Zr, defined: fh, destroyObjectProperties: ad, fireEvent: nd, isNumber: yl, objectEach: Ji, pick: vl } = $;
      function ld() {
        let h = this.inverted;
        this.axes.forEach((t) => {
      ...
      function cd() {
        this.stacking || (this.stacking = new fd(this));
      }
      function dd(h, t, e, i) {
      ...
      function gd(h) {
        (this.is("column") || this.is("columnrange")) && (this.options.centerInCategory && this.chart.series.length > 1 ? od.setStackedPoints.call(this, h, "group") : h.stacking.resetStacks());
      }
      function md(h, t) {
      ...
      class fd {
        ...
        renderStackTotals() {
          let t = this.axis, e = t.chart, i = e.renderer, s = this.stacks, r = rd(e, t.options.stackLabels?.animation || !1), o = this.stackTotalGroup = this.stackTotalGroup || i.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
      ...
      (ti || (ti = {})).compose = function(h, t, e) {
        ...
        i.getStacks || (mh(h, "init", cd), mh(h, "destroy", hd), i.getStacks = ld, s.getStackIndicator = dd, s.modifyStacks = ud, s.percentStacker = pd, s.setGroupedPoints = gd, s.setStackedPoints = md);
      };
      let xd = ti, { defined: bd, merge: xh, isObject: yd } = $;
      class bh extends ce {
        drawGraph() {
        ...
        getGraphPath(t, e, i) {
          ...
          return m && t.reverse(), (c = { right: 1, center: 2 }[c] || c && 3) && m && (c = 4 - c), (t = this.getValidPoints(t, !1, r.nullInteraction || !(r.connectNulls && !e && !i))).forEach(function(d, f) {
            ...
            (d.leftCliff || w?.rightCliff) && !i && (l = !0), v && !bd(e) && f > 0 ? l = !r.connectNulls : v && !e ? l = !0 : (f === 0 || l ? x = [["M", d.plotX, d.plotY]] : s.getPointSpline ? x = [s.getPointSpline(t, d, f)] : c ? (x = c === 1 ? [["L", w.plotX, M]] : c === 2 ? [["L", (w.plotX + y) / 2, w.plotY], ["L", (w.plotX + y) / 2, M]] : [["L", y, w.plotY]]).push(["L", y, M]) : x = [["L", y, M]], a.push(d.x), c && (a.push(d.x), c === 2 && a.push(d.x)), o.push.apply(o, x), l = !1);
          }), o.xMap = a, s.graphPath = o, o;
        }
      }
      bh.defaultOptions = xh(ce.defaultOptions, { legendSymbol: "lineMarker" }), Nt.registerSeriesType("line", bh);
      let { seriesTypes: { line: kl } } = Nt, { extend: vd, merge: kd, objectEach: wd, pick: Ca } = $;
      class wl extends kl {
        drawGraph() {
      ...
      wl.defaultOptions = kd(kl.defaultOptions, { threshold: 0, legendSymbol: "areaMarker" }), vd(wl.prototype, { singleStacks: !1 }), Nt.registerSeriesType("area", wl);
      let { line: yh } = Nt.seriesTypes, { merge: Md, pick: Aa } = $;
      class Ml extends yh {
      ...
      Ml.defaultOptions = Md(yh.defaultOptions), Nt.registerSeriesType("spline", Ml);
      let vh = Ml, { area: Cd, area: { prototype: Cl } } = Nt.seriesTypes, { extend: Ad, merge: Td } = $;
      class Al extends vh {
      }
      Al.defaultOptions = Td(vh.defaultOptions, Cd.defaultOptions), Ad(Al.prototype, { getGraphPath: Cl.getGraphPath, getStackPoints: Cl.getStackPoints, drawGraph: Cl.drawGraph }), Nt.registerSeriesType("areaspline", Al);
      let { animObject: Sd } = Rt, { parse: Ed } = yt, { noop: Pd } = X, { clamp: Ta, crisp: Sa, defined: kh, extend: wh, fireEvent: Mh, isArray: Ch, isNumber: Ea, merge: Tl, pick: _r, objectEach: Od } = $;
      class Pa extends ce {
        animate(t) {
          ...
          t && c ? (d.scaleY = 1e-3, i = Ta(r.toPixels(l.threshold || 0), o, o + r.len), m ? d.translateX = (i += a ? -Math.floor(c[0]) : Math.ceil(c[2])) - r.len : d.translateY = i += a ? Math.ceil(c[0]) : -Math.floor(c[2]), s.clipBox && s.setClip(), s.group.attr(d)) : (e = Number(s.group.attr(f)), s.group.animate({ scaleY: 1 }, wh(Sd(s.options.animation), { step: function(x, y) {
        ...
        adjustForMissingColumns(t, e, i, s) {
          if (!i.isNull && s.columnCount > 1) {
            ...
            Od(this.xAxis.stacking?.stacks, (c) => {
      ...
      (function(h) {
        ...
        function r(m) {
          let d;
          m = m || this.points;
          let f = this, x = f.chart, y = f.options, M = x.renderer, { backgroundColor: w, plotBackgroundColor: v } = x.options.chart, T = M.getContrast(Jr(v) && v || Jr(w) && w || "#000000"), S = l(f), { animation: O, defer: L } = S[0], D = L ? Ld(x, O, f) : { defer: 0, duration: 0 };
          Sl(this, "drawDataLabels"), f.hasDataLabels?.() && (d = this.initDataLabels(D), m.forEach((N) => {
            ...
            Sh(a(S, N.dlOptions || N.options?.dataLabels)).forEach((H, V) => {
              ...
              Z && (ct = Qi(vt = to(H[N.formatPrefix + "Format"], H.format)) ? Dd(vt, N, x) : (H[N.formatPrefix + "Formatter"] || H.formatter).call(N, H), ie = H.rotation, !x.styledMode && (_.color = to(H.color, _.color, Jr(f.color) ? f.color : void 0, "#000000"), _.color === "contrast" ? (J !== "none" && (lt = J), N.contrastColor = M.getContrast(lt !== "auto" && Jr(lt) && lt || (Jr(W) ? W : "")), _.color = lt || !Qi(q) && H.inside || 0 > Bd(q || 0) || y.stacking ? N.contrastColor : T) : delete N.contrastColor, y.cursor && (_.cursor = y.cursor)), st = { r: H.borderRadius || 0, rotation: ie, padding: H.padding, zIndex: 1 }, x.styledMode || (st.fill = J === "auto" ? N.color : J, st.stroke = j === "auto" ? N.color : j, st["stroke-width"] = H.borderWidth), Id(st, (kt, wt) => {
      ...
      let La = Mt, { composed: Nd } = X, { series: Eh } = Nt, { merge: Rd, pushUnique: zd } = $;
      (function(h) {
        function t(e, i, s, r, o) {
          ...
          if (f) {
            if (r = Rd(f), s.overflow !== "allow" || s.crop !== !1 || l.clip !== !1) {
        ...
        h.compose = function(e) {
          La.compose(Eh), zd(Nd, "ColumnDataLabel") && (e.prototype.alignDataLabel = t);
        };
      })(Et || (Et = {}));
      let Fd = Et, { extend: Hd, merge: Wd } = $;
      class El extends Oa {
      }
      El.defaultOptions = Wd(Oa.defaultOptions, {}), Hd(El.prototype, { inverted: !0 }), Nt.registerSeriesType("bar", El);
      let { column: Xd, line: Ph } = Nt.seriesTypes, { addEvent: Gd, extend: Yd, merge: jd } = $;
      class Da extends Ph {
        applyJitter() {
      ...
      Da.defaultOptions = jd(Ph.defaultOptions, { lineWidth: 0, findNearestPointBy: "xy", jitter: { x: 0, y: 0 }, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{point.color}">●</span> <span style="font-size: 0.8em"> {series.name}</span><br/>', pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>" } }), Yd(Da.prototype, { drawTracker: Xd.prototype.drawTracker, sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"] }), Gd(Da, "afterTranslate", function() {
        this.applyJitter();
      }), Nt.registerSeriesType("scatter", Da);
      let { deg2rad: Oh } = X, { fireEvent: Ud, isNumber: Pl, pick: Ia, relativeLength: Vd } = $;
      (function(h) {
        h.getCenter = function() {
          ...
          for (!e.angular || this instanceof ce || (y[3] = 0), f = 0; f < 4; ++f) x = y[f], c = f < 2 || f === 2 && /%$/.test(x), y[f] = Vd(x, [s, r, a, y[2]][f]) + (c ? i : 0);
          return y[3] > y[2] && (y[3] = y[2]), Pl(l) && 2 * l < y[2] && l > 0 && (y[3] = y[2] - 2 * l), Ud(this, "afterGetCenter", { positions: y }), y;
        }, h.getStartAndEndRadians = function(t, e) {
          let i = Pl(t) ? t : 0, s = Pl(e) && e > i && e - i < 360 ? e : i + 360;
          return { start: Oh * (i + -90), end: Oh * (s + -90) };
        };
      })(ae || (ae = {}));
      let Lh = ae, { setAnimation: qd } = Rt, { addEvent: Dh, defined: Kd, extend: $d, isNumber: Zd, pick: _d, relativeLength: Jd } = $;
      class Ih extends Bt {
        getConnectorPath(t) {
        ...
        slice(t, e, i) {
          let s = this.series;
          qd(i, s.chart), e = _d(e, !0), this.sliced = this.options.sliced = t = Kd(t) ? t : !this.sliced, s.options.data[s.data.indexOf(this)] = this.options, this.graphic && this.graphic.animate(this.getTranslate());
        }
      }
      $d(Ih.prototype, { connectorShapes: { fixedOffset: function(h, t, e) {
      ...
      let { getStartAndEndRadians: Qd } = Lh, { noop: Bh } = X, { clamp: tu, extend: eu, fireEvent: Nh, merge: Ol, pick: iu } = $;
      class Ll extends ce {
        animate(t) {
          let e = this, i = e.points, s = e.startAngleRad;
          t || i.forEach(function(r) {
            let o = r.graphic, a = r.shapeArgs;
            o && a && (o.attr({ r: iu(r.startR, e.center && e.center[3] / 2), start: s, end: s }), o.animate({ r: a.r, start: a.start, end: a.end }, e.options.animation));
          });
        }
        drawEmpty() {
        ...
        getX(t, e, i, s) {
          let r = this.center, o = this.radii ? this.radii[i.index] || 0 : r[2] / 2, a = s.dataLabelPosition, l = a?.distance || 0, c = Math.asin(tu((t - r[1]) / (o + l), -1, 1));
        ...
        translate(t) {
          ...
          let e = this.options, i = e.slicedOffset, s = Qd(e.startAngle, e.endAngle), r = this.startAngleRad = s.start, o = (this.endAngleRad = s.end) - r, a = this.points, l = e.ignoreHiddenPoint, c = a.length, m, d, f, x, y, M, w, v = 0;
      ...
      }, softConnector: !0, x: 0 }, fillColor: void 0, ignoreHiddenPoint: !0, inactiveOtherPoints: !0, legendType: "point", marker: null, size: null, showInLegend: !1, slicedOffset: 10, stickyTracking: !1, tooltip: { followPointer: !0 }, borderColor: "#ffffff", borderWidth: 1, lineWidth: void 0, states: { hover: { brightness: 0.1 } } }), eu(Ll.prototype, { axisTypes: [], directTouch: !0, drawGraph: void 0, drawTracker: Oa.prototype.drawTracker, getCenter: Lh.getCenter, getSymbol: Bh, invertible: !1, isCartesian: !1, noSharedTooltip: !0, pointAttribs: Oa.prototype.pointAttribs, pointClass: Ih, requireSorting: !1, searchPoint: Bh, trackerGroups: ["group", "dataLabelsGroup"] }), Nt.registerSeriesType("pie", Ll);
      let { composed: su, noop: ru } = X, { distribute: ou } = fs, { series: Rh } = Nt, { arrayMax: au, clamp: zh, defined: Fh, isNumber: nu, pick: lu, pushUnique: hu, relativeLength: Hh } = $;
      (function(h) {
        ...
        function i() {
            ...
            W && (o.sortByAngle(N, I - 0.5), D > 0 && (H = Math.max(0, M - y - D), V = Math.min(M + y + D, l.plotHeight), N.forEach((j) => {
              ...
              (j.dataLabels || []).forEach((q) => {
                ...
                if (ct) {
                  ...
                  if (ct.attribs = { visibility: wt, align: ct.alignment }, ct.posAttribs = { x: lt + (_.x || 0) + ({ left: st, right: -st }[ct.alignment] || 0), y: kt + (_.y || 0) - it / 2 }, ct.computed.x = lt, ct.computed.y = kt - pt, lu(_.crop, !0)) {
                    let mt;
          ...
          }), (au(v) === 0 || this.verifyDataLabelOverflow(v)) && (this.placeDataLabels(), this.points.forEach((N) => {
            (N.dataLabels || []).forEach((I) => {
        ...
        h.compose = function(o) {
          if (La.compose(Rh), hu(su, "PieDataLabel")) {
            let a = o.prototype;
            a.dataLabelPositioners = t, a.alignDataLabel = ru, a.drawDataLabels = i, a.getDataLabelPosition = e, a.placeDataLabels = s, a.verifyDataLabelOverflow = r;
          }
        };
      })(es || (es = {}));
      let cu = es;
      ...
      let { pointInPolygon: du } = gt, { addEvent: uu, getAlignFactor: pu, fireEvent: Wh, objectEach: Xh, pick: gu } = $;
      function mu(h) {
        let t = h.length, e = (m, d) => !(d.x >= m.x + m.width || d.x + d.width <= m.x || d.y >= m.y + m.height || d.y + d.height <= m.y), i = (m, d) => {
          for (let f of m) if (du({ x: f[0], y: f[1] }, d)) return !0;
          return !1;
        }, s, r, o, a, l, c = !1;
        for (let m = 0; m < t; m++) (s = h[m]) && (s.oldOpacity = s.opacity, s.newOpacity = 1, s.absoluteBox = (function(d) {
          if (d && (!d.alignAttr || d.placed)) {
            let f = d.box ? 0 : d.padding || 0, x = d.alignAttr || { x: d.attr("x"), y: d.attr("y") }, { height: y, polygon: M, width: w } = d.getBBox(), v = pu(d.alignValue) * w;
        ...
        for (let e of h.series || []) if (e.visible && e.hasDataLabels?.()) {
          let i = (s) => {
            for (let r of s) r.visible && (r.dataLabels || []).forEach((o) => {
              let a = o.options || {};
              o.labelrank = gu(a.labelrank, r.labelrank, r.shapeArgs?.height), a.allowOverlap ?? Number(a.distance) > 0 ? (o.oldOpacity = o.opacity, o.newOpacity = 1, Gh(o, h)) : t.push(o);
            });
          };
      ...
      let Yh = { compose: function(h) {
        let t = h.prototype;
        t.hideOverlappingLabels || (t.hideOverlappingLabels = mu, uu(h, "render", fu));
      } }, { defaultOptions: xu } = te, { noop: jh } = X, { addEvent: Uh, extend: bu, isObject: Vh, merge: yu, relativeLength: Dl } = $, vu = { radius: 0, scope: "stack", where: void 0 }, qh = jh, Kh = jh;
      function ku(h, t, e, i, s = {}) {
      ...
      function wu() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
          let { options: h, yAxis: t } = this, e = h.stacking === "percent", i = xu.plotOptions?.[this.type]?.borderRadius, s = Il(h.borderRadius, Vh(i) ? i : {}), r = t.options.reversed;
          for (let o of this.points) {
            ...
            if (o.shapeType === "roundedRect" && a) {
              ...
              y === "end" && (x && (d -= M), f += M), bu(a, { brBoxHeight: f, brBoxY: d, r: M });
            }
          }
        }
      }
      function Il(h, t) {
        return Vh(h) || (h = { radius: h || 0 }), yu(vu, t, h);
      }
      function Mu() {
      ...
      let { diffObjects: Au, extend: Tu, find: Su, merge: Eu, pick: Ba, uniqueKey: Pu } = $;
      (function(h) {
        function t(i, s) {
          let r = i.condition;
          (r.callback || function() {
        ...
        function e(i, s) {
          ...
          !s && r && r.rules && r.rules.forEach((d) => {
            d._id === void 0 && (d._id = Pu()), this.matchResponsiveRule(d, a);
          }, this);
          let c = Eu(...a.map((d) => Su(r?.rules || [], (f) => f._id === d)).map((d) => d?.chartOptions));
          c.isResponsiveOptions = !0, a = a.toString() || void 0;
          let m = o?.ruleIds;
          a !== m && (o && (this.currentResponsive = void 0, this.updatingResponsive = !0, this.update(o.undoOptions, i, !0), this.updatingResponsive = !1), a ? ((l = Au(c, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions = !0, this.currentResponsive = { ruleIds: a, mergedOptions: c, undoOptions: l }, this.updatingResponsive || this.update(c, i, !0)) : this.currentResponsive = void 0);
        }
        h.compose = function(i) {
          let s = i.prototype;
          return s.matchResponsiveRule || Tu(s, { matchResponsiveRule: t, setResponsive: e }), i;
        };
      })(is || (is = {}));
      let Ou = is;
      X.AST = Ct, X.Axis = vi, X.Chart = Ai, X.Color = yt, X.DataLabel = La, X.DataTableCore = xa, X.Fx = $t, X.HTMLElement = le, X.Legend = ih, X.LegendSymbol = Gl, X.OverlappingDataLabels = X.OverlappingDataLabels || Yh, X.PlotLineOrBand = oi, X.Point = Bt, X.Pointer = Hl, X.RendererRegistry = zi, X.Series = ce, X.SeriesRegistry = Nt, X.StackItem = gh, X.SVGElement = ge, X.SVGRenderer = Ms, X.Templating = Jt, X.Tick = bi, X.Time = Ks, X.Tooltip = k, X.animate = Rt.animate, X.animObject = Rt.animObject, X.chart = Ai.chart, X.color = yt.parse, X.dateFormat = Jt.dateFormat, X.defaultOptions = te.defaultOptions, X.distribute = fs.distribute, X.format = Jt.format, X.getDeferredAnimation = Rt.getDeferredAnimation, X.getOptions = te.getOptions, X.numberFormat = Jt.numberFormat, X.seriesType = Nt.seriesType, X.setAnimation = Rt.setAnimation, X.setOptions = te.setOptions, X.stop = Rt.stop, X.time = te.defaultTime, X.timers = $t.timers, { compose: function(h, t, e) {
        ...
        if (!t.symbolCustomAttribs.includes("borderRadius")) {
          ...
          Uh(h, "afterColumnTranslate", wu, { order: 9 }), Uh(i, "afterTranslate", Mu), t.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY", "brEnd", "brStart"), qh = s.arc, Kh = s.roundedRect, s.arc = ku, s.roundedRect = Cu;
        }
      }, optionsToObject: Il }.compose(X.Series, X.SVGElement, X.SVGRenderer), Fd.compose(X.Series.types.column), La.compose(X.Series), Yn.compose(X.Axis), le.compose(X.SVGRenderer), ih.compose(X.Chart), Ls.compose(X.Axis), Yh.compose(X.Chart), cu.compose(X.Series.types.pie), oi.compose(X.Chart, X.Axis), Hl.compose(X.Chart), Ou.compose(X.Chart), Kr.compose(X.Axis, X.Chart, X.Series), xd.compose(X.Axis, X.Chart, X.Series), k.compose(X.Pointer), $.extend(X, $);
      let Lu = X;
      return K.default;
    })());
  })(Na)), Na.exports;
...
var zu = Ru();
const Fu = /* @__PURE__ */ ic(zu);
var za = { exports: {} }, Hu = za.exports, Jh;
function Wu() {
  return Jh || (Jh = 1, (function(fe, Yt) {
    ...
    */
    ...
    })(typeof window > "u" ? Hu : window, (at, zt, ue, Vt, Dt, Zt, _t, oe, Oi, Li, ni) => (() => {
      let Qe;
...
class Xu {
  ...
  async loadDependencyWheelAndSankeyModules() {
    Qh || (await Promise.all([import("./dependency-wheel-BwNJL3ED.js").then((Yt) => Yt.d), import("./sankey-C_UoI-v0.js").then((Yt) => Yt.s)]), Qh = !0);
  }
